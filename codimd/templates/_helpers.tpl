...
*/}}
{{- define "codimd.image" -}}
{{- if (.Values.image.registry) -}} {{.Values.image.registry}}/ {{- end -}}{{.Values.image.repository}}:{{ .Values.image.tag | default .Chart.AppVersion }}{{- if (.Values.image.digest) -}} @{{.Values.image.digest}} {{- end -}}
{{- end -}}
...
{{- define "codimd.kubeVersion" -}}
  {{- default .Capabilities.KubeVersion.Version .Values.kubeVersionOverride -}}
{{- end -}}

{{/* Get Ingress API Version */}}
{{- define "codimd.ingress.apiVersion" -}}
  {{- if and (.Capabilities.APIVersions.Has "networking.k8s.io/v1") (semverCompare ">= 1.19-0" (include "codimd.kubeVersion" .)) -}}
...
{{- define "codimd.ingress.isStable" -}}
  {{- eq (include "codimd.ingress.apiVersion" .) "networking.k8s.io/v1" -}}
{{- end -}}

{{/* Check Ingress supports pathType */}}
{{/* pathType was added to networking.k8s.io/v1beta1 in Kubernetes 1.18 */}}
{{- define "codimd.ingress.supportsPathType" -}}
  {{- or (eq (include "codimd.ingress.isStable" .) "true") (and (eq (include "codimd.ingress.apiVersion" .) "networking.k8s.io/v1beta1") (semverCompare ">= 1.18-0" (include "codimd.kubeVersion" .))) -}}
{{- end -}}
